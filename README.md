<h1 align="center">
  <br>
  <a href="#"><img src="assets/senoide.png" alt="Just a logo with 2048 text" width="60"></a>
  <br>
...
> Este README pode sem baixado em PDF [aqui](readme.pdf) assim como o PDF de uma versão resumida [aqui](readmeResumido.pdf), a versão resumida pode ser vista online [aqui](https://hackmd.io/@taffarel55/adc-pwm-atmega328p-filter)
...
- [1. analogReadSerial](1.-analogReadSerial)
- [2. avaliacaoPWM](2.-avaliacaoPWM)
- [3. ModulacaoPWM entrada senoidal](3.-ModulacaoPWM-entrada-senoidal)
- [4. TCCR0B](4.-TCCR0B)
- [5. ADCSRA](5.-ADCSRA)
- [6. comFiltroRC](6.-comFiltroRC)
- [7. filtroAtivo](7.-filtroAtivo)

> O workspace do filtro projetado no ADS se encontra [aqui](filtro_wrk)
